...
<html lang="pt-br">
  ...
  <body class="text-center container d-flex align-items-center justify-content-center" style="height: 100vh;">
    <form class="form-signin" style="width: 30%" method="post" action="./pages/alunos.php">
      <h1 class="h3 mb-3 font-weight-normal">Login</h1>
      <label for="inputEmail" class="sr-only">R.A.></label>
      <input type="text" name="inputEmail" id="inputEmail" class="form-control" placeholder="R.A." required autofocus>
